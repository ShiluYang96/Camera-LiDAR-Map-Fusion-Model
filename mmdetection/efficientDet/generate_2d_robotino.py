...
def get_args():
    ...
    ap.add_argument('-p', '--project', type=str, default='robotino',
    ...
    ap.add_argument("--img_dir", help="image dir to be detected", type=str, default="/home/foj-sy/Downloads/dataset/Robotino/images")
    ap.add_argument('-w', '--weights', type=str, default="/home/foj-sy/ipa_one_stage_detection/ipa_one_stage_detection/efficientDet/logs/robotino/efficientdet-d0_63_632.pth",
...
def generate_proposals(preds, img_path, sub_out_dir):
    ...
    for j in range(len(preds['rois'])):
        ...
        for i in range(len(objs)):
            if (objs[i] == 'Robotino') & (len(context) < 200):  # save 200 highest proposals
                bbox = bboxes[i]
                if ((i + 1) < len(objs)) & (len(context) < 199):
                    write_line = "Robotino -1 -1 -10 {:.2f} {:.2f} {:.2f} {:.2f} -1 -1 -1 -1000 -1000 -1000 -10 {:.4f} \n". \
