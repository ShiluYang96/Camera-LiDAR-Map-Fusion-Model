...
model = dict(
    type="MapPP",
    pretrained='work_dirs/nusc_centerpoint_pp_02voxel_circle_nms/latest.pth', #'work_dirs/nusc_centerpoint_pp_02voxel_circle_nms/last.pth', # this is their fully trained model
    reader=dict(
