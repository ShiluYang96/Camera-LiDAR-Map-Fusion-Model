...
path_labels_train = os.fsencode("./yolo_train.txt")
path_labels_val = os.fsencode("./yolo_val.txt")
...
def transfer_yolo_to_coco(path_labels, coco_format_save_path):
...
if __name__ == '__main__':
    ...
    transfer_yolo_to_coco(path_labels_train, coco_format_save_path_train)
    print("###### train labels completed! ######")
    time.sleep(1)
    print("###### start to process val labels ######")
    transfer_yolo_to_coco(path_labels_val, coco_format_save_path_val)
