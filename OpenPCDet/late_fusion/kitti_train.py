...
from late_fusion.utils.kitti_dataset import clocs_data
import argparse
import torch
...
def parse_args():
    ...
    parser.add_argument('--cfg_file', type=str, default='./tool/cfgs/kitti_models/second/second_car.yaml',
                        help='specify the config for training')
    parser.add_argument('--rootpath', type=str, default='./data/clocs_data',
                        help='data root path')
    parser.add_argument('--d2path', type=str, default='./data/clocs_data/yolox_2D',
    ...
    parser.add_argument('--log-path', type=str, default='./log/second/test',
                        help='log path')
...
if __name__ == "__main__":
    ...
    input_data = root_path + '/input_data'
    train_ind_path = root_path + '/index/train.txt'
    val_ind_path = root_path + '/index/val.txt'
    trainval_ind_path = root_path + '/index/trainval.txt'
    infopath = root_path + '/info/kitti_infos_trainval.pkl'
    ...
    if args.generate :
        train_dataset = clocs_data(_2d_path, _3d_path,trainval_ind_path, input_data, infopath)
