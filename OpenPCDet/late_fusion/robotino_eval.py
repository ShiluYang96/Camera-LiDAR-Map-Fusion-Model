...
def parse_args():
    ...
    parser.add_argument('--log-path', type=str, default='../log/late_fusion',
                        help='log path')
    parser.add_argument('--baseline_eval', type=bool, default=False,
                        help='whether evaluate baseline model')
...
def eval(net, val_data, logf, log_path, epoch, cfg, eval_set, logger, args):
    net.eval()
    det_annos = []
...
if __name__ == "__main__":
    ...
    result_Path = Path(log_path + '/det_result')
    ...
    for epoch in range(0,50):
        ...
        eval(net, val_data, logf, log_path, epoch, cfg, eval_set, logger, args)